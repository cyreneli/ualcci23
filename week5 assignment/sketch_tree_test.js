...
function draw() {
  ...
  randomSeed(randomSeedValue);
  seed2(dotSize,radians(50),0,0,0,maxDepth);
  randomSeed(randomSeedValue);
  seed3(dotSize,radians(100),0,0,0,maxDepth);
  randomSeed(randomSeedValue);
  ...
  randomSeed(randomSeedValue);
  seed7(dotSize,radians(300),0,0,0,maxDepth);
  randomSeed(randomSeedValue);
  seed8(dotSize,radians(350),0,0,0,maxDepth);
  randomSeed(randomSeedValue);
...
function seed1(dotSize, angle, x, y,currentDepth,maxDepth) {
  if (dotSize > 1.0 && currentDepth < maxDepth) {
    let r = random(1); 
    ...
    if (r > 0.1) {
      ...
      randomSeed(2);
      seed2(dotSize * 0.99, angle + angleOffsetB, newx, newy,currentDepth+1,maxDepth);
      randomSeed(4);
      seed1(dotSize * 0.6, angle + angleOffsetB, newx, newy,currentDepth+1,maxDepth);
      randomSeed(5);
...
function seed2(dotSize, angle, x, y,currentDepth,maxDepth) {
    if (dotSize > 1.0 && currentDepth < maxDepth) {
      ...
      if (r > 0.05) {
        ...
        seed1(dotSize * 0.99, angle + angleOffsetB, newx, newy,currentDepth+1,maxDepth);
        randomSeed(2);
        seed2(dotSize * 0.6, angle + angleOffsetB, newx, newy,currentDepth+1,maxDepth);
        randomSeed(5);
        seed3(dotSize * 0.5, angle - angleOffsetB, newx, newy,currentDepth+1,maxDepth);
      } 
    }
  }
